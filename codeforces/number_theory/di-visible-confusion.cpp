...
int main() {
    ...
    while (n--) {
        ...
        while (x--) {
            ...
            // I think this doesn't work because it results in an overflow error
            // i should not be multiplying by count!, I should do LCM instead at each new value r instead
            // if (prod <= m) {
            //     prod *= count;
            // }
