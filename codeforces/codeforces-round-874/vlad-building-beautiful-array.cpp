...
int main() {
    ...
    // odd - odd -> even
    // even - odd -> odd
    // if there is an even number, need to 

    // General idea:
    // all even or odd -> yes
    // smallest is odd AND there exists at least one even -> yes
    // smallest is even AND there exists at least one odd -> no
    cin >> n;
    while (n--) {
        cin >> x;
        ul min = MAX;
